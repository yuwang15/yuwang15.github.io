 ...
 *
 * `poster` feeds the home hero and contact page, where the frame is cropped
 * wide; `cover` is the portrait still the films page parks on until playback,
 * so the two cannot always be the same image.
 */
export const brandFilms = [
  ...
  {
    slug: 'syw-film',
    title: { zh: 'Manifesto', en: 'Manifesto' } satisfies LocalizedString,
    ...
    cover: '/assets/films/manifesto.jpg',
